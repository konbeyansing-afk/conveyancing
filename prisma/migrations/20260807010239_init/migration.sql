...
-- CreateIndex
CREATE UNIQUE INDEX "CompletionRecord_userId_courseId_key" ON "CompletionRecord"("userId", "courseId");
...
-- AddForeignKey
ALTER TABLE "CompletionRecord" ADD CONSTRAINT "CompletionRecord_courseId_fkey" FOREIGN KEY ("courseId") REFERENCES "Course"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ResourceLibraryItem" ADD CONSTRAINT "ResourceLibraryItem_programId_fkey" FOREIGN KEY ("programId") REFERENCES "Program"("id") ON DELETE SET NULL ON UPDATE CASCADE;
